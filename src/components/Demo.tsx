        ...
        <div className="grid gap-6 max-w-6xl w-full mx-auto">
          <div className="border rounded-lg overflow-hidden grid gap-4 lg:gap-px lg:bg-gray-100">
            <div className="flex flex-col lg:flex-row bg-background text-sm p-2 relative">
              ...
              <Separator className="my-2 lg:hidden" />
              <div className="p-2 grid gap-1 flex-1">
                <div className="flex items-center gap-2 text-muted-foreground">17m ago by Raj</div>
              </div>
              <DropdownMenu>
            ...
            <div className="flex flex-col lg:flex-row bg-background text-sm p-2 relative">
              ...
              <Separator className="my-2 lg:hidden" />
              <div className="p-2 grid gap-1 flex-1">
                <div className="flex items-center gap-2 text-muted-foreground">32m ago by Joe</div>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="absolute top-4 right-4">
            ...
            <div className="flex flex-col lg:flex-row bg-background text-sm p-2 relative">
              ...
              <Separator className="my-2 lg:hidden" />
              <div className="p-2 grid gap-1 flex-1">
                <div className="flex items-center gap-2 text-muted-foreground">1 day ago by Chad</div>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="absolute top-4 right-4">
            ...
            <TabsContent value="integrations">
              <Card className="p-6">
                <CardHeader>
                  ...
                  <CardDescription>Connect your favorite tools and services to your deployments.</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="grid gap-1 flex-1">
                        ...
                        <div className="text-muted-foreground text-sm">
                          Integrate your GitHub repository for automatic deployments.
                        </div>
                      </div>
                      <Button variant="outline" size="sm" className="h-8 gap-1">
                        Connect
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="grid gap-1 flex-1">
                        ...
                        <div className="text-muted-foreground text-sm">Monitor your deployments with Datadog.</div>
                      </div>
                      <Button variant="outline" size="sm" className="h-8 gap-1">
                        Connect
                      </Button>
